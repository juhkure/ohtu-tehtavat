...
public class Stepdefs {
    ...
    public void setup() {
        ...
        userDao.add(new User("testikayttaja", "pekkapuu1"));
...
//    public void commandLoginSelected2() throws Throwable {
//        inputLines.add("login");
//    }
    ...
    @Then("system will resposnd with {string}")
    public void systemWillResposndWith(String expectedOutput) {
        assertTrue(io.getPrints().contains(expectedOutput));
    }
